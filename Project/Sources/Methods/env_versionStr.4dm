...
//@scope : private
//@deprecated : no
//@description : This function returns the 4D version (e.g. "4D v19.5 Final (Build 19.283893)", "4D v11r6")
//@parameter[0-OUT-4dversion-TEXT] : 4d version
//@notes :
//@example : ENV_versionStr => "4D v12.5 Final (Build 122263)", "4D v19 R7 Final (Build 19.100256)"
//@see : 
//@version : 1.00.00
...
If (Length:C16($va_appVers)=4)
	...
	$vt_versionStr:=$vt_versionStr+" (Build "+$va_appVersMajeur+"."+String:C10($vl_build)+")"
Else 
	$vt_versionStr:=$va_appVers+" ?"
End if 
